...
return [
    ...
    */
    ...
    'gt' => [
        ...
        'string' => 'يجب أن يكون حقل :attribute أكثر من :value حرفاً.',
    ],
    'gte' => [
    ...
    'hex_color' => 'يجب أن يكون حقل :attribute لوناً سادس عشرياً صالحاً.',
    ...
    'max' => [
        ...
        'string' => 'يجب ألا يكون حقل :attribute أكثر من :max حرفاً.',
    ],
    ...
    'missing_unless' => 'يجب أن يكون حقل :attribute مفقوداً إلا إذا كان :other في :value.',
    ...
    'password' => [
        ...
        'uncompromised' => 'القيمة المعطاة لـ :attribute ظهرت في تسرب بيانات. يرجى اختيار :attribute مختلف.',
    ],
    'present' => 'يجب أن يكون حقل :attribute موجوداً.',
    'present_if' => 'يجب أن يكون حقل :attribute موجوداً عندما يكون :other هو :value.',
    'present_unless' => 'يجب أن يكون حقل :attribute موجوداً إلا إذا كان :other في :value.',
    ...
    'unique' => 'تم أخذ :attribute من قبل.',
