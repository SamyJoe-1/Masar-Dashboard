            ...
            <div class="form-section active" id="section1">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="firstName" placeholder="John" oninput="renderPreview(); updateProgress();">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="lastName" placeholder="Doe" oninput="renderPreview(); updateProgress();">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex gap-3 align-items-start">
                        <div style="flex: 1;">
                            <input type="file" class="form-control" id="avatarUpload" accept="image/*" onchange="handleAvatarUpload(event)">
                            <small class="text-muted d-block mt-2">JPG, PNG or GIF (Max 5MB)</small>
                        </div>
                        <div id="avatarPreview" style="width: 100px; height: 100px; min-width: 100px; border-radius: 50%; background: #f0f0f0; display: flex; align-items: center; justify-content: center; border: 2px solid #e2e8f0;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jobTitle" placeholder="Senior Software Engineer" oninput="renderPreview(); updateProgress();">
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" placeholder="john.doe@example.com" oninput="renderPreview(); updateProgress();">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">Phone</label>
                            <input type="tel" class="form-control" id="phone" placeholder="+1 234 567 890" oninput="renderPreview(); updateProgress();">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label">Address</label>
                    <input type="text" class="form-control" id="address" placeholder="123 Main Street" oninput="renderPreview(); updateProgress();">
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">City/State</label>
                            <input type="text" class="form-control" id="cityState" placeholder="New York, NY" oninput="renderPreview(); updateProgress();">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">Country</label>
                            <input type="text" class="form-control" id="country" placeholder="United States" oninput="renderPreview(); updateProgress();">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="zipCode" placeholder="10001" oninput="renderPreview(); updateProgress();">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Driving License</label>
                                <input type="text" class="form-control" id="drivingLicense" placeholder="Class B" oninput="renderPreview(); updateProgress();">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="placeOfBirth" placeholder="Boston" oninput="renderPreview(); updateProgress();">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Date of Birth</label>
                                <input type="date" class="form-control" id="dateOfBirth" oninput="renderPreview(); updateProgress();">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Nationality</label>
                        <input type="text" class="form-control" id="nationality" placeholder="American" oninput="renderPreview(); updateProgress();">
                    </div>
                </div>
